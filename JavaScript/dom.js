...
// mainheaderElement.innerText = 'cow boy';
...
// targetDiv.style.height = '100px';
// targetDiv.styl.width = '100px';
targetDiv.style.fontSize = '40px';
...
// Can lead to security vulnerabilities (like XSS attacks) if not used carefully, especially with user input.
    ...
    // element.innerHTML = 'input type="type" placeholder="Enter your password">
    // console.log(element);
    // console.log(element.innerHTML)
